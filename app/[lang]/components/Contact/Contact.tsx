        ...
        <form className="my-8" onSubmit={handleSubmit}>
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
            <LabelInputContainer>
              ...
              <Input id="firstname" placeholder={dictionary.firstName} type="text" />
            </LabelInputContainer>
            <LabelInputContainer>
              <Label htmlFor="lastname">{dictionary.lastName}</Label>
              <Input id="lastname" placeholder={dictionary.lastName} type="text" />
            </LabelInputContainer>
          </div>
          <LabelInputContainer className="mb-4">
            <Label htmlFor="email">{dictionary.email}</Label>
            <Input id="email" placeholder={dictionary.email} type="email" />
          </LabelInputContainer>
          <LabelInputContainer className="mb-4">
            <Label htmlFor="content">{dictionary.content}</Label>
            <textarea
              ...
              id="content" placeholder={dictionary["content-place"]} cols={4} />
          </LabelInputContainer>
          <button
            className="bg-gradient-to-br relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
            type="submit"
          >
            {dictionary.button} &rarr;
            <BottomGradient />
          </button>
